/*! For license information please see stories-TodoApp-TodoDemo-stories.d2531126.iframe.bundle.js.LICENSE.txt */
'use strict';
  ...
  [856],
  {
    ...
    './dist/chunk-JUNSNYA5.cjs.js': (
      ...
      var _react = __webpack_require__('./node_modules/react/index.js'),
        ...
        React2 = _interopRequireWildcard(_react),
      ...
      var _antd = __webpack_require__('./node_modules/antd/es/index.js'),
        _reactresizablepanels = __webpack_require__(
        ...
        ActionListItem = React2.memo(
          React2.forwardRef(
            ({ label, onClick, id, isActive, ...rest }, ref) => {
              ...
              return React2.createElement(_core.NavLink, {
                ...rest,
                ref,
                label: React2.useMemo(
                  () =>
                ...
                rightSection: React2.useMemo(
                  () =>
                    React2.createElement(IconChevronRight, {
                      size: 12,
                      stroke: 1.5,
                    }),
                  [],
      ...
      var selectedAtomAtom = _vanilla.atom.call(void 0, void 0),
        ...
        SearchAtoms = React3.memo(() => {
          const [userInput, setUserInput] = _react2.useAtom.call(
            void 0,
            searchInputAtom,
            useDevtoolsJotaiStoreOptions(),
          );
          return React3.createElement(_core.TextInput, {
            label: 'Search',
        ...
        AtomGraphList = () => {
          ...
          const values = _react2.useAtomValue.call(
            ...
            valuesRef = React3.useRef(values);
          React3.useEffect(() => {
          ...
          const handleOnClick = React3.useCallback(
            ...
            atomItems = React3.useMemo(
              () =>
                values.map(([atom8], i) => {
                  const atomKey = atom8.toString();
                  return React3.createElement(ActionListItem, {
          ...
          return React3.createElement(
            React3.Fragment,
            null,
            React3.createElement(SearchAtoms, null),
            ...
            noResultsFound &&
              React3.createElement(
                ...
                React3.createElement(IconAlertCircle, { size: 16 }),
                React3.createElement(
                  _core.Text,
                  {
                    fz: 'sm',
      ...
      var CustomNode_default = _react.memo.call(
        ...
        AtomGraphVisual = React42.default.memo(() => {
          useSyncSnapshotValuesToAtom();
          const values = _react2.useAtomValue.call(
              void 0,
              allValues,
            ...
            valuesRef = React42.default.useRef(values);
          React42.default.useEffect(() => {
            valuesRef.current = values;
          }, [values]);
          const atomNodes = () => {
              const nodesArray = [];
          ...
          const onConnect = _react.useCallback.call(
            void 0,
            (params) =>
          ...
          return React42.default.createElement(
            ...
            React42.default.createElement(
              ...
              React42.default.createElement(
                ...
                React42.default.createElement(_reactflow.Controls, null),
              ),
              React42.default.createElement(_reactflow.Background, {
      ...
      React42.default.memo(() =>
        React42.default.createElement(
          ...
          React42.default.createElement(
            ...
            { defaultSize: 50, minSize: 30 },
            React42.default.createElement(
              _antd.Flex,
              { p: 10, pt: 0, h: '100%', direction: 'column' },
      ...
      var use =
        ...
        isInternalAtomSubscribeFunction = (cb) =>
          _optionalChain([cb, 'optionalAccess', (_15) => _15.isJotaiDevTools]);
            ...
            () => {
              const devSubscribeStore =
                _optionalChain([
                  userStore,
                  'optionalAccess',
                  (_16) => _16.dev_subscribe_store,
                ]) ||
                _optionalChain([
                  userStore,
                  'optionalAccess',
                  (_17) => _17.dev_subscribe_state,
                ]);
              if (!devSubscribeStore) return;
              const atomSubCb = () => {
                rerender();
                  ...
                  if (activeValue) {
                    const { l = [], t } =
                      _optionalChain([
                        userStore,
                        'access',
                        (_19) => _19.dev_get_mounted,
                        'optionalCall',
                        (_20) => _20(activeValue.atom),
                      ]) || {};
                    if (
    ...
    './dist/index.cjs.js': (
      ...
      __webpack_require__('./dist/chunk-JUNSNYA5.cjs.js');
      var _chunk5K6HCVT2cjsjs = __webpack_require__(
        './dist/chunk-5K6HCVT2.cjs.js',
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
