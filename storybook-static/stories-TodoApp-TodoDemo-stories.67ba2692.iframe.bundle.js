/*! For license information please see stories-TodoApp-TodoDemo-stories.67ba2692.iframe.bundle.js.LICENSE.txt */
'use strict';
  ...
  [856],
  {
    ...
    './dist/chunk-4EA3P3K4.cjs.js': (
      ...
      var _react = __webpack_require__('./node_modules/react/index.js'),
        ...
        React7 = _interopRequireWildcard(_react),
        ...
        React30 = _interopRequireWildcard(_react),
      ...
      var CustomNode_default = _react.memo.call(
          ...
          function CustomNode({ data }) {
            return React40.default.createElement(
              'div',
              null,
      ...
      React40.default.memo(() => {
        ...
        const values = _react2.useAtomValue.call(
          ...
          valuesRef = React40.default.useRef(values);
        React40.default.useEffect(() => {
            ...
            return (
              values.map(([atom8], i) => {
                ...
                nodesArray.push({
                  ...
                  type: 'custom',
                  position: { x: (i % 10) * 125, y: 125 * Math.floor(i / 10) },
        ...
        PanelResizeHandle = () =>
          React40.default.createElement(
            ...
            React40.default.createElement(
              ...
              React40.default.createElement(_core.Box, {
      ...
      var AtomDependentsList = ({ atom: atom8 }) => {
        const { dependents } = useAtomsSnapshots(),
          ...
          listOfDependents = React5.useMemo(
            () =>
      ...
      var MetaInfo = ({ label, value, color }) =>
        ...
        AtomMetaDetails = React7.memo(
          ({ debugLabel, atomValueType, isAtomPrivate }) =>
            React7.createElement(
              _core.Box,
              null,
              React7.createElement(_core.Text, { fw: 'bold', mb: 10 }, 'Meta'),
              React7.createElement(MetaInfo, {
                label: 'Debug Label',
                value: debugLabel,
              }),
              React7.createElement(MetaInfo, {
        ...
        ErrorMessage = ({ message }) => {
          ...
          return React8.createElement(
            ...
            React8.createElement(
              ...
              React8.createElement(IconAlertCircle, { size: 16 }),
            ),
            message,
          );
        };
      ...
      var getJsonTreeTheme = (base16Theme) => {
        ...
        JSONTree = (props) => {
          ...
          return React40.default.createElement(
            ...
            React40.default.createElement(_reactjsontree.JSONTree, {
              hideRoot: !0,
      ...
      var _codehighlight = __webpack_require__(
        ...
        MemoizedValueRenderer = React11.memo(({ value }) =>
          React11.createElement(CodeSyntaxHighlighter, {
            code: value,
            language: 'javascript',
            mb: 10,
        ...
        AtomValue = ({ atomValue }) => {
          ...
          if (parsedValue === ErrorSymbol)
            return React40.default.createElement(
              ...
              React40.default.createElement(ErrorMessage, {
                ...
                React40.default.createElement(
                  ...
                  React40.default.createElement(
                    ...
                    React40.default.createElement(
                      ...
                      {
                        value: 'raw-value',
                        leftSection: React40.default.createElement(
                          IconSourceCode,
                  ...
                  React40.default.createElement(
                    ...
                    React40.default.createElement(MemoizedValueRenderer, {
                      value: parsedValue,
                    }),
                  ),
                  React40.default.createElement(
                    ...
                    React40.default.createElement(JSONTree, {
                      data: atomValue,
                    }),
                  ),
                ),
        ...
        DisplayAtomDetails = ({ atom: atom8 }) => {
          ...
          return React40.default.createElement(
            ...
            React40.default.createElement(AtomMetaDetails, {
            ...
            React40.default.createElement(AtomValue, { atomValue }),
            React40.default.createElement(AtomDependentsList, { atom: atom8 }),
          );
        },
        AtomDetail = React14.memo(() => {
          ...
          return selectedAtomData
            ? React14.createElement(
                React14.Suspense,
                {
                  fallback: React14.createElement(_core.LoadingOverlay, {
                    visible: !0,
                    overlayProps: { blur: 2 },
                    loaderProps,
                  }),
                },
                React14.createElement(DisplayAtomDetails, {
      ...
      var ActionListItem_module_default = {},
        ActionListItem = React15.memo(
          React15.forwardRef(
            ({ label, onClick, id, isActive, ...rest }, ref) => {
              const handleOnClick = React15.useCallback(
                () => onClick(id),
                [onClick, id],
              );
              return React15.createElement(_core.NavLink, {
                ...rest,
                ref,
                label: React15.useMemo(
                  () =>
                ...
                rightSection: React15.useMemo(
                  () =>
                    React15.createElement(IconChevronRight, {
                      size: 12,
                      stroke: 1.5,
                    }),
                  [],
      ...
      var AtomList_module_default = {},
        SearchAtoms = React16.memo(() => {
          const [userInput, setUserInput] = _react2.useAtom.call(
            void 0,
            searchInputAtom,
            useDevtoolsJotaiStoreOptions(),
          );
          return React16.createElement(_core.TextInput, {
            label: 'Search',
        ...
        AtomList = () => {
          ...
          const values = _react2.useAtomValue.call(
            ...
            valuesRef = React16.useRef(values);
          React16.useEffect(() => {
            valuesRef.current = values;
          }, [values]);
          const handleOnClick = React16.useCallback(
            ...
            atomItems = React16.useMemo(
              () =>
                values.map(([atom8], i) => {
                  const atomKey = atom8.toString();
                  return React16.createElement(ActionListItem, {
          ...
          return React16.createElement(
            React16.Fragment,
            null,
            React16.createElement(SearchAtoms, null),
            ...
            noResultsFound &&
              React16.createElement(
                ...
                React16.createElement(IconAlertCircle, { size: 16 }),
                React16.createElement(
                  _core.Text,
                  {
                    fz: 'sm',
        ...
        React17.createElement(
          ...
          React17.createElement(
            ...
            React17.createElement(
              ...
              React17.createElement(AtomList, null),
            ),
          ),
          React17.createElement(PanelResizeHandle, null),
          React17.createElement(
            _reactresizablepanels.Panel,
            {
              defaultSize: 50,
            ...
            React17.createElement(
              ...
              React17.createElement(AtomDetail, null),
            ),
          ),
        ),
      );
      ...
      var ThemeToggle = () => {
          ...
          return React40.default.createElement(
            ...
            dark
              ? React40.default.createElement(IconSun, { size: 16 })
              : React40.default.createElement(IconMoonStars, { size: 16 }),
          );
        },
          ...
          return React20.createElement(
            ...
            React20.createElement(
              ...
              React20.createElement(
                _core.Flex,
                { align: 'center' },
                React20.createElement(ThemeToggle, null),
                React20.createElement(
                  _core.ActionIcon,
                  {
                    ml: 10,
                  ...
                  React20.createElement(IconMinus, { size: 16 }),
                ),
              ),
            ),
          );
        ...
        TabsHeader = React22.memo(() => {
          ...
          return React22.createElement(
            ...
            React22.createElement(
              ...
              {
                value: 'atom-viewer',
                leftSection: React22.createElement(IconLayoutList, {
                  size: 14,
                }),
                classNames: {
            ...
            React22.createElement(
              ...
              {
                value: 'time-travel',
                leftSection: React22.createElement(IconTimeline, { size: 14 }),
            ...
            React22.createElement(
              ...
              {
                value: 'atom-graph',
                icon: React22.createElement(IconVectorTriangle, { size: 14 }),
              },
              'Atom Graph',
            ),
          );
      ...
      var options = Object.keys(defaultPlaybackOptions),
        PlaybackSpeedDropdown = () => {
          ...
          return React40.default.createElement(_core.Select, {
            value,
            data: options,
            defaultValue: '1x',
            onChange: (value2) => {
        ...
        PlayBar = () => {
          ...
          return React40.default.createElement(
            ...
            React40.default.createElement(
              ...
              isTimeTraveling
                ? React40.default.createElement(IconPlayerPauseFilled, {
                    size: 16,
                  })
                : React40.default.createElement(IconPlayerPlayFilled, {
                    size: 16,
                  }),
            ),
            React40.default.createElement(_core.Slider, {
              value,
              label: null,
              size: 'xs',
              max,
            ...
            React40.default.createElement(
              ...
              React40.default.createElement(
                ...
                React40.default.createElement(IconChevronLeft, { size: 16 }),
              ),
              React40.default.createElement(
                _core.ActionIcon,
                {
                ...
                React40.default.createElement(IconChevronRight, { size: 16 }),
              ),
            ),
            React40.default.createElement(PlaybackSpeedDropdown, null),
          );
        };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
            ...
            React40.default.createElement(
              _core.Button,
              {
                ...
                leftSection: justRestored
                  ? React40.default.createElement(IconCircleCheck, {
                      size: '0.8rem',
                    })
                  : React40.default.createElement(IconRotate2, {
                      size: '0.8rem',
                    }),
                disabled:
      ...
      var SnapshotMetaDetails = (props) =>
        React40.default.createElement(
          ...
          React40.default.createElement(MetaInfo, {
            label: 'Timestamp',
      ...
      var prepareDelta = (value) => {
            ...
            React40.default.createElement(
              ...
              React40.default.createElement(
                ...
                React40.default.createElement(
                  ...
                  {
                    value: 'state',
                    leftSection: React40.default.createElement(IconFileCode, {
                      size: '0.9rem',
                      stroke: '1.75',
                    }),
                  },
                ...
                React40.default.createElement(
                  ...
                  {
                    value: 'diff',
                    leftSection: React40.default.createElement(IconFileDiff, {
                      size: '0.9rem',
                      stroke: '1.75',
                    }),
                  },
              ...
              React40.default.createElement(
                ...
                React40.default.createElement(TreeView, {
        ...
        DisplaySnapshotDetails = (props) =>
          React40.default.createElement(
            ...
            React40.default.createElement(SnapshotMetaDetails, {
              timestamp: props.details.timestamp,
            }),
            React40.default.createElement(SnapshotValue, {
              state: props.details,
            }),
            React40.default.createElement(SnapshotActions, {
        ...
        SnapshotDetail = React30.memo(() => {
          ...
          return selectedSnapshotDetail
            ? React30.createElement(
                React30.Suspense,
                {
                  fallback: React30.createElement(_core.LoadingOverlay, {
                    visible: !0,
                    overlayProps: { blur: 2 },
                    loaderProps,
                  }),
                },
                React30.createElement(DisplaySnapshotDetails, {
      ...
      var ClearHistory = () => {
          ...
          return React40.default.createElement(
            ...
            React40.default.createElement(IconTrashX, { size: 16 }),
          );
        },
      ...
      var RecordHistory = () => {
        ...
        return React40.default.createElement(
          ...
          React40.default.createElement(
            ...
            React40.default.createElement(IconPlayerRecordFilled, { size: 18 }),
          ),
        );
      };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        ...
        SnapshotListNavigation = () => {
          ...
          return React40.default.createElement(
            ...
            React40.default.createElement(
              ...
              React40.default.createElement(IconChevronUp, { size: 16 }),
            ),
            React40.default.createElement(
              _core.ActionIcon,
              {
              ...
              React40.default.createElement(IconChevronDown, { size: 16 }),
            ),
          );
        };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
      var SnapshotSearchInput = _react.memo.call(void 0, () => {
          ...
          return React40.default.createElement(_core.TextInput, {
            placeholder: 'Search',
            value: userInput,
            onChange: (event) => {
              const {
          ...
          React40.default.createElement(
            ...
            React40.default.createElement(
              ...
              React40.default.createElement(
                _core.Group,
                null,
                React40.default.createElement(RecordHistory, null),
                React40.default.createElement(ClearHistory, null),
              ),
              React40.default.createElement(SnapshotListNavigation, null),
            ),
            React40.default.createElement(SnapshotSearchInput, null),
          ),
        ...
        SnapshotList = () => {
            ...
            snapshotHistoryList = _react.useMemo.call(
              ...
              () =>
                historyList.map(({ id, label }) => {
                  ...
                  return React40.default.createElement(ActionListItem, {
                    key: `snapshot-${id}`,
                    label: String(label),
                    onClick: handleOnClick,
                    id,
          ...
          return React40.default.createElement(
            React40.default.Fragment,
            null,
            React40.default.createElement(Header2, null),
            React40.default.createElement(
              _core.Box,
              {
                className:
            ...
            noResultsFound &&
              React40.default.createElement(
                _core.Group,
                { mt: 20, justify: 'center' },
                React40.default.createElement(IconAlertCircle, { size: 16 }),
                React40.default.createElement(
                  _core.Text,
                  {
                    component: 'span',
          ...
          React37.createElement(
            ...
            React37.createElement(
              ...
              React37.createElement(
                ...
                React37.createElement(SnapshotList, null),
              ),
            ),
            React37.createElement(PanelResizeHandle, null),
            React37.createElement(
              _reactresizablepanels.Panel,
              {
                defaultSize: 55,
              ...
              React37.createElement(
                _core.Flex,
                { p: 10, h: '100%', direction: 'column', pos: 'relative' },
                React37.createElement(SnapshotDetail, null),
              ),
            ),
          ),
          React37.createElement(PlayBar, null),
        ),
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
      var defaultProps = { position: 'bottom-left' };
      React39.forwardRef((_, ref) => {
      ...
      exports.InternalDevTools = (props) =>
        React40.createElement(React40.Fragment, null);
    },
    './dist/chunk-5K6HCVT2.cjs.js': (
      __unused_webpack_module,
      exports,
    ...
    './dist/index.cjs.js': (
      ...
      __webpack_require__('./dist/chunk-4EA3P3K4.cjs.js');
      var _chunk5K6HCVT2cjsjs = __webpack_require__(
        './dist/chunk-5K6HCVT2.cjs.js',
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
