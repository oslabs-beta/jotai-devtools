(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        400: 'stories-TodoApp-TodoDemo-stories',
        599: 'stories-Default-Playground-Playground-stories',
        859: 'stories-ProviderLess-DevToolsProviderLess-stories',
        977: 'stories-Default-DevTools-stories',
      })[chunkId] || chunkId) +
      '.' +
      {
        39: '3c390377',
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'jotai-devtools:' + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 'jotai-devtools:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkjotai_devtools =
          self.webpackChunkjotai_devtools || []);
