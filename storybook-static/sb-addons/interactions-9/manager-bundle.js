try {
  (() => {
    ...
    var zi = _((hR, $i) => {
      ...
      function $y(e) {
        ...
        for (var r in Object(e))
          ky.call(e, r) && r != 'constructor' && t.push(r);
        return t;
      }
      $i.exports = $y;
    });
    ...
    var Kl = _((D4, Yl) => {
      ...
      function M1(e, t, r) {
        var n = e[t];
        (!(q1.call(e, t) && B1(n, r)) || (r === void 0 && !(t in e))) &&
          F1(e, t, r);
      }
      Yl.exports = M1;
    });
    ...
    var $c = _((R9, kc) => {
      ...
      function av(e) {
        ...
        var t = tv(e),
          r = [];
        for (var n in e)
          (n == 'constructor' && (t || !ov.call(e, n))) || r.push(n);
        return r;
      }
      kc.exports = av;
    });
    ...
    var mp = _((Mq, hp) => {
      ...
      hp.exports = function (t) {
        var r = this;
        if (typeof r != 'function' || Av.apply(r) !== Cv)
          throw new TypeError(Sv + r);
        for (
    ...
    var Mp = _((mM, qp) => {
      ...
      qp.exports = function (t, r) {
        ...
        return (
          (o || a || !n) &&
            (Jv ? Fp(t, 'length', r, !0, !0) : Fp(t, 'length', r)),
          t
        );
      };
    });
      ...
      var US = Yr(),
        ...
        YS = function (t, r, n, o, a) {
          ...
          for (var c = '', p = 0; p < i.length; p += To) {
            for (
              var d = i.length >= To ? i.slice(p, p + To) : i, h = [], m = 0;
              m < d.length;
              ++m
            ) {
      ...
      var wf = bf(),
        ...
        aA = function (t) {
          ...
          if (typeof t.format < 'u') {
            if (!eA.call(ar.formatters, t.format))
...
`,
            ...
            function ia(b, C) {
              ...
              return (
                xe &&
                  xe.length > Te &&
                  (xe = ''.concat(f, '(').concat(b.children.length, ')')),
        ...
        return (
          Ze(() => {
            t.value instanceof Promise &&
              (async (m) => {
                d(
                  Be(t.key, `Promise { "${await xd(m)}" }`, pe.key, n, t.depth),
                );
              })(t.value);
          }, [t, n]),
    ...
    var kC = {
      ...
      aa = ({ call: e, callsById: t }) => {
        ...
        if (e.method === 'step' && e.path.length === 0)
          return y.createElement(ax, { label: e.args[0] });
