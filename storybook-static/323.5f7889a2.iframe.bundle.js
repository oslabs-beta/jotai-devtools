  ...
  [323],
  {
    ...
    './node_modules/@mantine/core/esm/components/Transition/Transition.mjs': (
      ...
      const popIn = (from) => ({
        ...
        transitions = {
          ...
          'fade-up': {
            ...
            out: { opacity: 0, transform: `translateY(${(0, rem.D)(30)}` },
          ...
          'fade-left': {
            ...
            out: { opacity: 0, transform: `translateX(${(0, rem.D)(30)}` },
            transitionProperty: 'opacity, transform',
          },
          'fade-right': {
            in: { opacity: 1, transform: 'translateX(0)' },
      ...
      var react_dom = __webpack_require__('./node_modules/react-dom/index.js'),
        use_media_query = __webpack_require__(
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function getCSSColorVariables({
          ...
          if ('light' === colorScheme) {
            const primaryShade2 = (0, get_primary_shade.g)(theme, 'light'),
              dynamicVariables2 = {
                [`--mantine-color-${name}-text`]: `var(--mantine-color-${name}-filled)`,
                [`--mantine-color-${name}-filled`]: `var(--mantine-color-${name}-${primaryShade2})`,
                [`--mantine-color-${name}-filled-hover`]: `var(--mantine-color-${name}-${9 === primaryShade2 ? 8 : primaryShade2 + 1})`,
                [`--mantine-color-${name}-light`]: (0, rgba.X)(
                  theme.colors[color][primaryShade2],
                  0.1,
                ),
                [`--mantine-color-${name}-light-hover`]: (0, rgba.X)(
                  theme.colors[color][primaryShade2],
                  0.12,
                ),
                ...
                [`--mantine-color-${name}-outline-hover`]: (0, rgba.X)(
                  theme.colors[color][primaryShade2],
                  0.05,
                ),
              };
          ...
          const primaryShade = (0, get_primary_shade.g)(theme, 'dark'),
            dynamicVariables = {
              [`--mantine-color-${name}-text`]: `var(--mantine-color-${name}-4)`,
              [`--mantine-color-${name}-filled`]: `var(--mantine-color-${name}-${primaryShade})`,
              [`--mantine-color-${name}-filled-hover`]: `var(--mantine-color-${name}-${9 === primaryShade ? 8 : primaryShade + 1})`,
              [`--mantine-color-${name}-light`]: (0, rgba.X)(
        ...
        const defaultCssVariablesResolver = (theme) => {
          const lightPrimaryShade = (0, get_primary_shade.g)(theme, 'light'),
            defaultRadius =
              ...
              if (
                (function isVirtualColor(value) {
                  return (
                    !!value &&
                    'object' == typeof value &&
                    'mantine-virtual-color' in value
                  );
                })(value)
              )
                return (
    ...
    './node_modules/@mantine/core/esm/core/utils/units-converters/rem.mjs': (
      ...
      function scaleRem(remValue) {
        return '0rem' === remValue
          ? '0rem'
          : `calc(${remValue} * var(--mantine-scale))`;
      }
    ...
    './node_modules/@mantine/hooks/esm/use-media-query/use-media-query.mjs': (
      ...
      function useMediaQuery(
        ...
        const [matches, setMatches] = (0,
          ...
          queryRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
        return (
