/*! For license information please see stories-TodoApp-TodoDemo-stories.11ac2091.iframe.bundle.js.LICENSE.txt */
'use strict';
  ...
  [856],
  {
    ...
    './dist/chunk-XGRFRCIG.cjs.js': (
      ...
      var _react = __webpack_require__('./node_modules/react/index.js'),
        ...
        React40 = _interopRequireWildcard(_react),
      ...
      var CustomNode_default = _react.memo.call(
          ...
          function CustomNode({ data }) {
            return React41.default.createElement(
              'div',
              null,
              React41.default.createElement(
                'div',
                {
        ...
        AtomGraphVisual = React41.default.memo(() => {
          useSyncSnapshotValuesToAtom();
          const values = _react2.useAtomValue.call(
            ...
            valuesRef = React41.default.useRef(values);
          React41.default.useEffect(() => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(
                ...
                React41.default.createElement(_reactflow.Controls, null),
              ),
              React41.default.createElement(_reactflow.Background, {
      ...
      React41.default.memo(() =>
        React41.default.createElement(
          ...
          React41.default.createElement(
            _reactresizablepanels.Panel,
            { defaultSize: 50, minSize: 30 },
            React41.default.createElement(AtomGraphVisual, null),
          ),
        ),
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        ...
        PanelResizeHandle = () =>
          React41.default.createElement(
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(_core.Box, {
      ...
      var AtomDependentsList = ({ atom: atom8 }) => {
        const { dependents } = useAtomsSnapshots(),
          ...
          listOfDependents = React6.useMemo(
            () =>
      ...
      var MetaInfo = ({ label, value, color }) =>
        ...
        AtomMetaDetails = React8.memo(
          ({ debugLabel, atomValueType, isAtomPrivate }) =>
            React8.createElement(
              _core.Box,
              null,
              React8.createElement(_core.Text, { fw: 'bold', mb: 10 }, 'Meta'),
              React8.createElement(MetaInfo, {
                label: 'Debug Label',
                value: debugLabel,
              }),
              React8.createElement(MetaInfo, {
        ...
        ErrorMessage = ({ message }) => {
          ...
          return React9.createElement(
            ...
            React9.createElement(
              ...
              React9.createElement(IconAlertCircle, { size: 16 }),
            ),
            message,
          );
        };
      ...
      var getJsonTreeTheme = (base16Theme) => {
        ...
        JSONTree = (props) => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(_reactjsontree.JSONTree, {
              hideRoot: !0,
      ...
      var _codehighlight = __webpack_require__(
        ...
        MemoizedValueRenderer = React12.memo(({ value }) =>
          React12.createElement(CodeSyntaxHighlighter, {
            code: value,
            language: 'javascript',
            mb: 10,
        ...
        AtomValue = ({ atomValue }) => {
          ...
          if (parsedValue === ErrorSymbol)
            return React41.default.createElement(
              ...
              React41.default.createElement(ErrorMessage, {
                ...
                React41.default.createElement(
                  ...
                  React41.default.createElement(
                    ...
                    React41.default.createElement(
                      ...
                      {
                        value: 'raw-value',
                        leftSection: React41.default.createElement(
                          IconSourceCode,
                  ...
                  React41.default.createElement(
                    ...
                    React41.default.createElement(MemoizedValueRenderer, {
                      value: parsedValue,
                    }),
                  ),
                  React41.default.createElement(
                    ...
                    React41.default.createElement(JSONTree, {
                      data: atomValue,
                    }),
                  ),
                ),
        ...
        DisplayAtomDetails = ({ atom: atom8 }) => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(AtomMetaDetails, {
            ...
            React41.default.createElement(AtomValue, { atomValue }),
            React41.default.createElement(AtomDependentsList, { atom: atom8 }),
          );
        },
        AtomDetail = React15.memo(() => {
          ...
          return selectedAtomData
            ? React15.createElement(
                React15.Suspense,
                {
                  fallback: React15.createElement(_core.LoadingOverlay, {
                    visible: !0,
                    overlayProps: { blur: 2 },
                    loaderProps,
                  }),
                },
                React15.createElement(DisplayAtomDetails, {
      ...
      var ActionListItem_module_default = {},
        ActionListItem = React16.memo(
          React16.forwardRef(
            ({ label, onClick, id, isActive, ...rest }, ref) => {
              const handleOnClick = React16.useCallback(
                () => onClick(id),
                [onClick, id],
              );
              return React16.createElement(_core.NavLink, {
                ...rest,
                ref,
                label: React16.useMemo(
                  () =>
                ...
                rightSection: React16.useMemo(
                  () =>
                    React16.createElement(IconChevronRight, {
                      size: 12,
                      stroke: 1.5,
                    }),
                  [],
      ...
      var AtomList_module_default = {},
        SearchAtoms = React17.memo(() => {
          const [userInput, setUserInput] = _react2.useAtom.call(
            void 0,
            searchInputAtom,
            useDevtoolsJotaiStoreOptions(),
          );
          return React17.createElement(_core.TextInput, {
            label: 'Search',
        ...
        AtomList = () => {
          ...
          const values = _react2.useAtomValue.call(
            ...
            valuesRef = React17.useRef(values);
          React17.useEffect(() => {
            valuesRef.current = values;
          }, [values]);
          const handleOnClick = React17.useCallback(
              (pos) => {
            ...
            atomItems = React17.useMemo(
              () =>
                values.map(([atom8], i) => {
                  const atomKey = atom8.toString();
                  return React17.createElement(ActionListItem, {
          ...
          return React17.createElement(
            React17.Fragment,
            null,
            React17.createElement(SearchAtoms, null),
            ...
            noResultsFound &&
              React17.createElement(
                ...
                React17.createElement(IconAlertCircle, { size: 16 }),
                React17.createElement(
                  _core.Text,
                  {
                    fz: 'sm',
        ...
        React18.createElement(
          ...
          React18.createElement(
            ...
            React18.createElement(
              ...
              React18.createElement(AtomList, null),
            ),
          ),
          React18.createElement(PanelResizeHandle, null),
          React18.createElement(
            _reactresizablepanels.Panel,
            {
              defaultSize: 50,
            ...
            React18.createElement(
              ...
              React18.createElement(AtomDetail, null),
            ),
          ),
        ),
      );
      ...
      var ThemeToggle = () => {
          ...
          return React41.default.createElement(
            ...
            dark
              ? React41.default.createElement(IconSun, { size: 16 })
              : React41.default.createElement(IconMoonStars, { size: 16 }),
          );
        },
          ...
          return React21.createElement(
            ...
            React21.createElement(
              ...
              React21.createElement(
                _core.Flex,
                { align: 'center' },
                React21.createElement(ThemeToggle, null),
                React21.createElement(
                  _core.ActionIcon,
                  {
                    ml: 10,
                  ...
                  React21.createElement(IconMinus, { size: 16 }),
                ),
              ),
            ),
          );
        ...
        TabsHeader = React23.memo(() => {
          ...
          return React23.createElement(
            ...
            React23.createElement(
              ...
              {
                value: 'atom-viewer',
                leftSection: React23.createElement(IconLayoutList, {
                  size: 14,
                }),
                classNames: {
            ...
            React23.createElement(
              ...
              {
                value: 'time-travel',
                leftSection: React23.createElement(IconTimeline, { size: 14 }),
            ...
            React23.createElement(
              ...
              {
                value: 'atom-graph',
                icon: React23.createElement(IconVectorTriangle, { size: 14 }),
              },
              'Atom Graph',
            ),
          );
      ...
      var options = Object.keys(defaultPlaybackOptions),
        PlaybackSpeedDropdown = () => {
          ...
          return React41.default.createElement(_core.Select, {
            value,
            data: options,
            defaultValue: '1x',
            onChange: (value2) => {
        ...
        PlayBar = () => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(
              ...
              isTimeTraveling
                ? React41.default.createElement(IconPlayerPauseFilled, {
                    size: 16,
                  })
                : React41.default.createElement(IconPlayerPlayFilled, {
                    size: 16,
                  }),
            ),
            React41.default.createElement(_core.Slider, {
              value,
              label: null,
              size: 'xs',
              max,
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(
                ...
                React41.default.createElement(IconChevronLeft, { size: 16 }),
              ),
              React41.default.createElement(
                _core.ActionIcon,
                {
                ...
                React41.default.createElement(IconChevronRight, { size: 16 }),
              ),
            ),
            React41.default.createElement(PlaybackSpeedDropdown, null),
          );
        };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
            ...
            React41.default.createElement(
              _core.Button,
              {
                ...
                leftSection: justRestored
                  ? React41.default.createElement(IconCircleCheck, {
                      size: '0.8rem',
                    })
                  : React41.default.createElement(IconRotate2, {
                      size: '0.8rem',
                    }),
                disabled:
      ...
      var SnapshotMetaDetails = (props) =>
        React41.default.createElement(
          ...
          React41.default.createElement(MetaInfo, {
            label: 'Timestamp',
      ...
      var prepareDelta = (value) => {
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(
                ...
                React41.default.createElement(
                  ...
                  {
                    value: 'state',
                    leftSection: React41.default.createElement(IconFileCode, {
                      size: '0.9rem',
                      stroke: '1.75',
                    }),
                  },
                ...
                React41.default.createElement(
                  ...
                  {
                    value: 'diff',
                    leftSection: React41.default.createElement(IconFileDiff, {
                      size: '0.9rem',
                      stroke: '1.75',
                    }),
                  },
              ...
              React41.default.createElement(
                ...
                React41.default.createElement(TreeView, {
        ...
        DisplaySnapshotDetails = (props) =>
          React41.default.createElement(
            ...
            React41.default.createElement(SnapshotMetaDetails, {
              timestamp: props.details.timestamp,
            }),
            React41.default.createElement(SnapshotValue, {
              state: props.details,
            }),
            React41.default.createElement(SnapshotActions, {
        ...
        SnapshotDetail = React31.memo(() => {
          ...
          return selectedSnapshotDetail
            ? React31.createElement(
                React31.Suspense,
                {
                  fallback: React31.createElement(_core.LoadingOverlay, {
                    visible: !0,
                    overlayProps: { blur: 2 },
                    loaderProps,
                  }),
                },
                React31.createElement(DisplaySnapshotDetails, {
      ...
      var ClearHistory = () => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(IconTrashX, { size: 16 }),
          );
        },
      ...
      var RecordHistory = () => {
        ...
        return React41.default.createElement(
          ...
          React41.default.createElement(
            ...
            React41.default.createElement(IconPlayerRecordFilled, { size: 18 }),
          ),
        );
      };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        ...
        SnapshotListNavigation = () => {
          ...
          return React41.default.createElement(
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(IconChevronUp, { size: 16 }),
            ),
            React41.default.createElement(
              _core.ActionIcon,
              {
              ...
              React41.default.createElement(IconChevronDown, { size: 16 }),
            ),
          );
        };
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
      var SnapshotSearchInput = _react.memo.call(void 0, () => {
          ...
          return React41.default.createElement(_core.TextInput, {
            placeholder: 'Search',
            value: userInput,
            onChange: (event) => {
              const {
          ...
          React41.default.createElement(
            ...
            React41.default.createElement(
              ...
              React41.default.createElement(
                _core.Group,
                null,
                React41.default.createElement(RecordHistory, null),
                React41.default.createElement(ClearHistory, null),
              ),
              React41.default.createElement(SnapshotListNavigation, null),
            ),
            React41.default.createElement(SnapshotSearchInput, null),
          ),
        ...
        SnapshotList = () => {
            ...
            snapshotHistoryList = _react.useMemo.call(
              ...
              () =>
                historyList.map(({ id, label }) => {
                  ...
                  return React41.default.createElement(ActionListItem, {
                    key: `snapshot-${id}`,
                    label: String(label),
                    onClick: handleOnClick,
                    id,
          ...
          return React41.default.createElement(
            React41.default.Fragment,
            null,
            React41.default.createElement(Header2, null),
            React41.default.createElement(
              _core.Box,
              {
                className:
            ...
            noResultsFound &&
              React41.default.createElement(
                _core.Group,
                { mt: 20, justify: 'center' },
                React41.default.createElement(IconAlertCircle, { size: 16 }),
                React41.default.createElement(
                  _core.Text,
                  {
                    component: 'span',
          ...
          React38.createElement(
            ...
            React38.createElement(
              ...
              React38.createElement(
                ...
                React38.createElement(SnapshotList, null),
              ),
            ),
            React38.createElement(PanelResizeHandle, null),
            React38.createElement(
              _reactresizablepanels.Panel,
              {
                defaultSize: 55,
              ...
              React38.createElement(
                _core.Flex,
                { p: 10, h: '100%', direction: 'column', pos: 'relative' },
                React38.createElement(SnapshotDetail, null),
              ),
            ),
          ),
          React38.createElement(PlayBar, null),
        ),
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0),
        _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
      var defaultProps = { position: 'bottom-left' };
      React40.forwardRef((_, ref) => {
      ...
      exports.InternalDevTools = (props) =>
        React41.createElement(React41.Fragment, null);
    },
    './dist/index.cjs.js': (
      __unused_webpack_module,
      exports,
      ...
      __webpack_require__('./dist/chunk-XGRFRCIG.cjs.js');
      var _chunk5K6HCVT2cjsjs = __webpack_require__(
        './dist/chunk-5K6HCVT2.cjs.js',
      );
      _chunk5K6HCVT2cjsjs.init_react_shim.call(void 0);
