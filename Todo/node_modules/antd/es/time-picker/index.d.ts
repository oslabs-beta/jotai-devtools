...
import type { PickerProps, PickerPropsWithMultiple, RangePickerProps } from 'antd/es/date-picker/generatePicker/interface';
export type PickerTimeProps<DateType extends AnyObject> = PickerPropsWithMultiple<DateType, Omit<PickerProps<DateType>, 'picker' | 'showTime'>>;
